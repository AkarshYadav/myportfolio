...
import ProjectAll from "@/public/image/coding.png";
					...
					<ReactFullpage.Wrapper>
							...
							<div className="mx-auto container grid grid-cols-1 md:grid-cols-3 gap-4 p-10 overflow-hidden md:px-20">
								<motion.div
									...
									<motion.p
										...
										A passionate web development enthusiast currently studying at IIIT Vadodara. I love building modern, user-friendly web applications and constantly explore new technologies to expand my skills. Always eager to learn, grow, and collaborate on exciting projects.
									</motion.p>
									<motion.div
						...
						<div className="section">
							<div className="relative md:h-screen w-screen gap-4 p-10 flex justify-center items-center flex-col overflow-hidden">
								<div className="z-0 mb-48 md:mb-0  md:absolute top-1/4  md:right-[10%] md:-translate-y-16 ">
									<motion.div
										className=" rounded-sm h-[400px] md:h-[600px] w-[80vw] md:w-[30vw]  "
										initial={{
											x: 300,
											opacity: 0,
											z: -100,
							...
							<div className="relative md:h-screen w-screen  gap-4 p-10 flex justify-center items-center flex-col overflow-hidden">
								...
								<div className="z-10 w-full absolute md:w-auto  md:left-[10%] top-[60%] md:top-1/3 col-span-2 flex flex-col justify-center items-start md:items-start text-start px-10 overflow-hidden">
									...
									<motion.p
										...
										<a href="mailto:akarshyadav2308@gmail.com?subject=Hello&body=Hello Alvalens,">
											akarshyadav2308@gmail.com
										</a>
									</motion.p>
									{/* icons */}
									<div className="flex justify-center items-center space-x-4">
										<motion.a
											href="mailto:akarshyadav2308@gmail.com?subject=Hello&body=Hello Akarsh ,"
										...
										<motion.a
											href="https://github.com/AkarshYadav"
											target="_blank"
											rel="noopener noreferrer"
											className="flex justify-center items-center bg-gray-700 w-14 h-14 rounded-full text-gray-100 hover:bg-gray-400 transition-all ease-in-out duration-300"
										...
										<motion.a
											href="https://www.instagram.com/akarshxd?igsh=dHRybGNjMXhrMTc4"
											target="_blank"
											rel="noopener noreferrer"
											className="flex justify-center items-center bg-gray-700 w-14 h-14 rounded-full text-gray-100 hover:bg-gray-400 transition-all ease-in-out duration-300"
											initial={{ opacity: 0, y: 40 }}
										...
										<motion.a
											href="https://www.linkedin.com/in/akarsh-yadav-03ab80245/"
											target="_blank"
											rel="noopener noreferrer"
											className="flex justify-center items-center bg-gray-700 w-14 h-14 rounded-full text-gray-100 hover:bg-gray-400 transition-all ease-in-out duration-300"
											initial={{ opacity: 0, y: 40 }}
